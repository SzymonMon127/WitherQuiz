...
public class PrivatePolicyURLActivity extends AppCompatActivity {
    ...
    protected String privatePolicy = " Privacy Policy\n" +
            ...
            "\n" +
            "\n" +
            "Application means the software program provided by the Company downloaded by You on any electronic device, named Witcher Quizzes\n" +
            "\n" +
            "\n" +
            "Company (referred to as either \"the Company\", \"We\", \"Us\" or \"Our\" in this Agreement) refers to Witcher Quizzes.\n" +
            "\n" +
            "\n" +
