...
public class QuizGameActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int gameId = (Integer)getIntent().getExtras().get(EXTRA_GAME_ID);

        if (gameId ==1)
        {

            Id = 21;
            NumberOfQuestions = 117;
    ...
    public void OnClickNextQuestion(View view) {
        ...
        else
        {
            ...
            Intent intent = new Intent(QuizGameActivity.this, ScoreActivity.class);
    ...
    public void Questions()
    {
        ...
        QuestionsGameFragment question2 = new QuestionsGameFragment();
